...
class RoleAdminTests(unittest.TestCase):
 ...
 def test_structured_street_lookup_uses_safe_public_variants(self):
  ...
  xml=b'\xef\xbb\xbf<?xml version="1.0"?><RL><VERSION>2.9</VERSION><RLM01A>01023</RLM01A><RLM02A>2026</RLM02A><RLUEx><RL0101><RL0101Ax>262</RL0101Ax><RL0101Gx>EDGAR-H\xc3\x89BERT</RL0101Gx></RL0101><RL0104><RL0104A>1</RL0104A></RL0104><RL0404A>300000</RL0404A></RLUEx></RL>'
  import_territory(1,self.db,'01023',lambda _:xml)
  found=search_role_units(self.db,'01023','262 Rue Edgar-Hébert')
  self.assertEqual(found[0]['civic_number'],'262')
  self.assertIn('rôle 01023',found[0]['field_provenance'])
  self.assertEqual(search_role_units(self.db,'01023','263 Rue Edgar-Hébert'),[])
  self.assertEqual(role_street_variants(self.db,'01023','263 Rue Edgar-Hébert'),['EDGAR-HÉBERT'])
 def test_beauharnois_70022_import_keeps_observed_xml_version(self):
  ...
  refresh_index(1,self.db,lambda _:index)
  xml=b'\xef\xbb\xbf<?xml version="1.0"?><RL><VERSION>2.9</VERSION><RLM01A>70022</RLM01A><RLM02A>2026</RLM02A><RLUEx><RL0101><RL0101Ax>262</RL0101Ax><RL0101Gx>EDGAR-H\xc3\x89BERT</RL0101Gx></RL0101><RL0104><RL0104A>1</RL0104A></RL0104><RL0404A>404100</RL0404A></RLUEx></RL>'
  ...
  self.assertEqual(search_role_units(self.db,'70022','262 Rue Edgar-Hébert')[0]['total_value'],404100.0)
